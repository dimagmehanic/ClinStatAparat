...
**Variable BASE_CA**
  ```{r} 
  get_skewness(adlb_wide$BASE_CA, na.rm = TRUE) 
  ```
  </div> 
...
**Variable AGE**
  ```{r} 
  get_skewness(adlb_wide$AGE, na.rm = TRUE) 
  ```
  </div>
</div>
...
**Variable BASE_CA**
  ```{r} 
  get_kurtosis(adlb_wide$BASE_CA, na.rm = TRUE) 
  ```
  </div> 
...
**Variable AGE**
  ```{r} 
  get_kurtosis(adlb_wide$AGE, na.rm = TRUE) 
  ```
  </div>
</div>
